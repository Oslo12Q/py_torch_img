...
class Solver(object):
    ...
    def __init__(self, celeba_loader, rafd_loader, my_loader, config):
    ...
    def build_model(self):
        ...
        if self.dataset in ['CelebA', 'RaFD', 'Mytest']:
    ...
    def create_labels(self, c_org, c_dim=1, dataset='CelebA', selected_attrs=None):
